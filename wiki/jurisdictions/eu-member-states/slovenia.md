---
type: Authority
title: Cyber Resilience Act Implementation in Slovenia
description: Designated national authorities, market surveillance, CSIRT reporting routing, and enforcement measures for the Cyber Resilience Act in Slovenia.
category: authority
tags: [cra, jurisdiction, eu-member-state, slovenia, authorities, market-surveillance, csirt]
status: draft
...
sources:
  ...
  - id: ec-nando-cra
    ...
    last_modified: 2026-08-21T00:00:00Z
  - id: si-uradnilist
    resource: https://www.uradni-list.si/
    title: Official Gazette of the Republic of Slovenia (Uradni list RS)
    author: Uradni list Republike Slovenije d.o.o.
    last_modified: 2026-08-21T00:00:00Z
  - id: si-sicert
    resource: https://www.cert.si/
    title: SI-CERT (Slovenian Computer Emergency Response Team)
    author: Arnes
    last_modified: 2026-08-21T00:00:00Z
x-cra:
  ...
  notifying_authority: Ministry of Digital Transformation (Ministrstvo za digitalno preobrazbo - MDP) / Ministry of the Economy, Tourism and Sport
  market_surveillance_authority: Information Security Administration of the Republic of Slovenia (Urad Vlade Republike Slovenije za informacijsko varnost - UIV) and Market Inspectorate of the Republic of Slovenia (TIRS)
  legislation_status: pending
  csirt_routing: SI-CERT (Slovenian Computer Emergency Response Team / Arnes)
  source_language: sl
...
Implementation, market surveillance structure, and incident notification routing for Regulation (EU) 2024/2847 (Cyber Resilience Act)[^cra-regulation] in Slovenia.

# Competent authorities

## Notifying authority
Under CRA Article 35, Slovenia designates its notifying authority responsible for setting up and carrying out assessment and notification procedures for conformity assessment bodies (notified bodies):
- Designated authority: Ministry of Digital Transformation (Ministrstvo za digitalno preobrazbo - MDP) / Ministry of the Economy, Tourism and Sport[^ec-nando-cra].

## Market surveillance authority
Under CRA Article 52 and Regulation (EU) 2019/1020, market surveillance of products with digital elements placed on the Slovenia market is conducted by:
- Designated market surveillance authority: Information Security Administration of the Republic of Slovenia (Urad Vlade Republike Slovenije za informacijsko varnost - UIV) and Market Inspectorate of the Republic of Slovenia (TIRS)[^ec-cra-ms].
...
- Designated CSIRT / reporting recipient: SI-CERT (Slovenian Computer Emergency Response Team / Arnes)[^si-sicert].
...
- Official legal gazette / registry: Official Gazette of the Republic of Slovenia (Uradni list RS)[^si-uradnilist].
...
[^si-uradnilist]: Uradni list Republike Slovenije d.o.o., Official Gazette of the Republic of Slovenia (Uradni list RS), https://www.uradni-list.si/
[^si-sicert]: Arnes, SI-CERT (Slovenian Computer Emergency Response Team), https://www.cert.si/
