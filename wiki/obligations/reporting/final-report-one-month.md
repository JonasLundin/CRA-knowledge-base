...
x-cra:
  ...
  provision: Article 14(2)(e), Article 14(4)(e)
...
The final report is the concluding submission of the Article 14 reporting procedure. It must be submitted through the Single Reporting Platform no later than one month after a corrective or mitigating measure is deployed (for vulnerabilities) or after the incident has been handled (for severe incidents).[^cra-art-14] [^enisa-srp-docs]
...
Under Article 14(2)(e) and 14(4)(e), the final report must contain:
