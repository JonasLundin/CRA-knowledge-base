...
Article 14(5)–(7) of Regulation (EU) 2024/2847 mandates that all notifications of actively exploited vulnerabilities and severe incidents be submitted via the Single Reporting Platform (SRP) established and maintained by ENISA.[^cra-art-14] [^enisa-srp-docs]
...
1. **Simultaneous routing:** When a report is submitted, the SRP transmits it simultaneously to:
   - The designated CSIRT of the Member State where the manufacturer has its main establishment;
   - The CSIRTs of Member States where the product is marketed (subject to dissemination rules);
   - ENISA (Article 14(6)).[^cra-art-14]
2. **Dissemination delay rules (Delegated Regulation (EU) 2026/881):** To prevent premature exposure of unpatched zero-days, dissemination to other Member State CSIRTs or market surveillance authorities may be delayed where the notifying manufacturer provides justified cybersecurity grounds indicating that immediate dissemination would expose users to heightened risk prior to patch availability;[^reg-2026-881]
3. **CSIRT coordinator powers:** The lead CSIRT may decide on the appropriate timing of wider dissemination and coordinate technical remediation with other national CSIRTs;
