---
type: Authority
title: Cyber Resilience Act Implementation in Malta
description: Designated national authorities, market surveillance, CSIRT reporting routing, and enforcement measures for the Cyber Resilience Act in Malta.
category: authority
tags: [cra, jurisdiction, eu-member-state, malta, authorities, market-surveillance, csirt]
status: draft
...
sources:
  ...
  - id: ec-nando-cra
    ...
    last_modified: 2026-08-21T00:00:00Z
  - id: mt-legislation
    resource: https://legislation.mt/
    title: Legislation Malta (Gazzetta tal-Gvern ta' Malta)
    author: Ministry for Justice and Reform of the Construction Sector
    last_modified: 2026-08-21T00:00:00Z
  - id: mt-csm
    resource: https://cybersecurity.gov.mt/
    title: Cyber Security Malta / MITA-CSIRT
    author: Malta Information Technology Agency (MITA)
    last_modified: 2026-08-21T00:00:00Z
x-cra:
  jurisdiction_code: MT
  jurisdiction_name: Malta
  eu_eea_status: eu_member_state
  notifying_authority: Malta Competition and Consumer Affairs Authority (MCCAA) / Ministry for the Economy, Enterprise and Strategic Projects
  market_surveillance_authority: Technical Regulations Division (MCCAA) and Malta Critical Infrastructure Directorate / Cyber Security Malta
  legislation_status: pending
  csirt_routing: CSIRT Malta (MITA-CSIRT / National Cyber Security Coordination)
  source_language: mt, en
...
Implementation, market surveillance structure, and incident notification routing for Regulation (EU) 2024/2847 (Cyber Resilience Act)[^cra-regulation] in Malta.

# Competent authorities

## Notifying authority
Under CRA Article 35, Malta designates its notifying authority responsible for setting up and carrying out assessment and notification procedures for conformity assessment bodies (notified bodies):
- Designated authority: Malta Competition and Consumer Affairs Authority (MCCAA) / Ministry for the Economy, Enterprise and Strategic Projects[^ec-nando-cra].

## Market surveillance authority
Under CRA Article 52 and Regulation (EU) 2019/1020, market surveillance of products with digital elements placed on the Malta market is conducted by:
- Designated market surveillance authority: Technical Regulations Division (MCCAA) and Malta Critical Infrastructure Directorate / Cyber Security Malta[^ec-cra-ms].
...
- Designated CSIRT / reporting recipient: CSIRT Malta (MITA-CSIRT / National Cyber Security Coordination)[^mt-csm].
...
- Official legal gazette / registry: Legislation Malta (Gazzetta tal-Gvern ta' Malta)[^mt-legislation].
...
[^mt-legislation]: Ministry for Justice and Reform of the Construction Sector, Legislation Malta (Gazzetta tal-Gvern ta' Malta), https://legislation.mt/
[^mt-csm]: Malta Information Technology Agency (MITA), Cyber Security Malta / MITA-CSIRT, https://cybersecurity.gov.mt/
